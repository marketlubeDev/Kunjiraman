...
K. Kunjiraman <span className="text-green-600">Cleaning Solutions</span>
</div>
</div>
{/* Desktop Navigation */}
<nav className="hidden md:flex space-x-8">
<a href="#home" onClick={(e) => { e.preventDefault(); document.getElementById('home').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-700 hover:text-blue-600 font-medium cursor-pointer">Home</a>
<a href="#about" onClick={(e) => { e.preventDefault(); document.getElementById('about').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-700 hover:text-blue-600 font-medium cursor-pointer">About</a>
<a href="#services" onClick={(e) => { e.preventDefault(); document.getElementById('services').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-700 hover:text-blue-600 font-medium cursor-pointer">Services</a>
<a href="#clients" onClick={(e) => { e.preventDefault(); document.getElementById('clients').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-700 hover:text-blue-600 font-medium cursor-pointer">Clients</a>
<a href="#contact" onClick={(e) => { e.preventDefault(); document.getElementById('contact').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-700 hover:text-blue-600 font-medium cursor-pointer">Contact</a>
</nav>
{/* Mobile menu button */}
...
<a href="#home" onClick={(e) => { e.preventDefault(); document.getElementById('home').scrollIntoView({ behavior: 'smooth' }); setIsMenuOpen(false); }} className="text-gray-700 hover:text-blue-600 font-medium py-2 border-b border-gray-100 cursor-pointer">Home</a>
<a href="#about" onClick={(e) => { e.preventDefault(); document.getElementById('about').scrollIntoView({ behavior: 'smooth' }); setIsMenuOpen(false); }} className="text-gray-700 hover:text-blue-600 font-medium py-2 border-b border-gray-100 cursor-pointer">About</a>
<a href="#services" onClick={(e) => { e.preventDefault(); document.getElementById('services').scrollIntoView({ behavior: 'smooth' }); setIsMenuOpen(false); }} className="text-gray-700 hover:text-blue-600 font-medium py-2 border-b border-gray-100 cursor-pointer">Services</a>
<a href="#clients" onClick={(e) => { e.preventDefault(); document.getElementById('clients').scrollIntoView({ behavior: 'smooth' }); setIsMenuOpen(false); }} className="text-gray-700 hover:text-blue-600 font-medium py-2 border-b border-gray-100 cursor-pointer">Clients</a>
<a href="#contact" onClick={(e) => { e.preventDefault(); document.getElementById('contact').scrollIntoView({ behavior: 'smooth' }); setIsMenuOpen(false); }} className="text-gray-700 hover:text-blue-600 font-medium py-2 cursor-pointer">Contact</a>
</div>
</div>
)}
</header>
{/* Hero Banner */}
<section id="home" className="relative bg-gradient-to-r from-blue-900 to-blue-700 overflow-hidden">
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-4 transition-colors duration-300 hover:text-blue-600">Our Cleaning Services</h2>
<p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4 transition-colors duration-300 hover:text-gray-800">
We provide a comprehensive range of cleaning essentials to meet all your hygiene needs, from homes to institutions.
</p>
</div>
...
<h3 className="text-xl font-bold text-gray-800 whitespace-nowrap">Floor Cleaners</h3>
</div>
<p className="text-gray-600 mb-4 line-clamp-2 h-12">
Professional-grade floor cleaning solutions that effectively remove dirt and stains.
</p>
</div>
</div>
{/* Service 2 */}
...
<h3 className="text-xl font-bold text-gray-800 whitespace-nowrap">Toilet Cleaners</h3>
</div>
<p className="text-gray-600 mb-4 line-clamp-2 h-12">
Advanced formulation toilet cleaners that eliminate 99.9% of germs and effectively.
</p>
</div>
</div>
{/* Service 3 */}
...
<h3 className="text-xl font-bold text-gray-800 whitespace-nowrap">Glass & Mirror Cleaners</h3>
</div>
<p className="text-gray-600 mb-4 line-clamp-2 h-12">
Specialized cleaning solutions that deliver streak-free shine and crystal-clear results.
</p>
</div>
</div>
{/* Service 4 */}
...
<h3 className="text-xl font-bold text-gray-800 whitespace-nowrap">Handwash & Sanitizers</h3>
</div>
<p className="text-gray-600 mb-4 line-clamp-2 h-12">
Gentle yet powerful hand hygiene products enriched with skin-friendly ingredients.
</p>
</div>
</div>
{/* Service 5 */}
...
<h3 className="text-xl font-bold text-gray-800 whitespace-nowrap">Multipurpose Cleaners</h3>
</div>
<p className="text-gray-600 mb-4 line-clamp-2 h-12">
Versatile cleaning solutions designed to effectively clean multiple surface types.
</p>
</div>
</div>
{/* Service 6 */}
...
<h3 className="text-xl font-bold text-gray-800 whitespace-nowrap">Household Cleaning Items</h3>
</div>
<p className="text-gray-600 mb-4 line-clamp-2 h-12">
Comprehensive selection of professional-grade cleaning tools and accessories.
</p>
</div>
</div>
</div>
...
<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-4">Why Choose Us</h2>
<p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">
We take pride in offering the best cleaning solutions with exceptional service quality.
</p>
</div>
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Trusted Legacy</h3>
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Branded Quality</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Wide Range</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Expert Support</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">
...
<div className="container mx-auto px-4">
<div className="text-center mb-10 md:mb-16">
<h2 className="text-3xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-4">How We Work</h2>
<p className="text-base md:text-lg text-gray-600 max-w-2xl mx-auto px-4">
Our simple 3-step process ensures you get the best cleaning solutions for your needs.
</p>
</div>
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Enquire With Us</h3>
<p className="text-gray-600 transition-all duration-300 group-hover:text-gray-800">
Contact us via call, WhatsApp message, or visit our store to discuss your requirements.
</p>
</div>
</div>
{/* Arrow */}
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Get Quality Products</h3>
<p className="text-gray-600 transition-all duration-300 group-hover:text-gray-800">
Choose from our wide range of branded cleaning essentials suited to your needs.
</p>
</div>
</div>
{/* Arrow */}
...
<h3 className="text-xl font-bold text-gray-800 mb-3 transition-colors duration-300 group-hover:text-blue-600">Get Clean Environment</h3>
<p className="text-gray-600 transition-all duration-300 group-hover:text-gray-800">
Achieve hygienic results at every scale, from homes to large institutions.
</p>
</div>
</div>
</div>
...
<h2 className="text-2xl md:text-4xl font-bold text-gray-800 mb-4 md:mb-6 text-center md:text-left">About K. Kunjiraman Cleaning Solutions</h2>
<p className="text-gray-600 mb-6">
For over 35 years, K. Kunjiraman Cleaning Solutions has been Calicut's trusted partner for comprehensive cleaning essentials. As an authorized dealer of premium brands like Diversey & Taski, we offer high-quality cleaning products for homes, offices, hospitals, hotels, and other institutions.
</p>
<p className="text-gray-600 mb-6">
Our extensive range of products ensures that all your cleaning needs are met under one roof. With our expert guidance, we help you choose the right cleaning solutions for your specific requirements.
</p>
<div className="flex flex-wrap gap-4 justify-center md:justify-start">
<div className="bg-white p-4 rounded-lg shadow-md flex items-center">
<i className="fas fa-check-circle text-green-500 text-xl mr-3"></i>
<span className="text-gray-800 font-medium">Authorized Diversey Dealer</span>
</div>
<div className="bg-white p-4 rounded-lg shadow-md flex items-center">
<i className="fas fa-check-circle text-green-500 text-xl mr-3"></i>
<span className="text-gray-800 font-medium">Authorized Taski Dealer</span>
</div>
</div>
</div>
<div className="w-full md:w-1/2">
...
<h3 className="text-2xl font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">35+ Years</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">Of Experience & Excellence</p>
</div>
</div>
<div className="flex items-center group transition-all duration-300 hover:-translate-x-1 cursor-pointer">
<div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mr-4 transition-all duration-300 group-hover:bg-blue-200 group-hover:shadow-lg">
...
<div className="transition-all duration-300 group-hover:translate-x-2">
<h3 className="text-xl font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Location</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">Court Rd, Mananchira, Kozhikode, Kerala 673032</p>
</div>
</div>
<div className="flex items-center group transition-all duration-300 hover:-translate-x-1 cursor-pointer">
<div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mr-4 transition-all duration-300 group-hover:bg-blue-200 group-hover:shadow-lg">
...
<div className="transition-all duration-300 group-hover:translate-x-2">
<h3 className="text-xl font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Contact</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">Phone: +91 98460 06545</p>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">Email: jpwcp486@gmail.com</p>
</div>
</div>
<div className="flex items-center group transition-all duration-300 hover:-translate-x-1 cursor-pointer">
<div className="w-16 h-16 bg-blue-100 rounded-full flex items-center justify-center mr-4 transition-all duration-300 group-hover:bg-blue-200 group-hover:shadow-lg">
...
<div className="transition-all duration-300 group-hover:translate-x-2">
<h3 className="text-xl font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Shop Hours</h3>
<p className="text-gray-600 transition-colors duration-300 group-hover:text-gray-800">9 AM - 8 PM, Monday to Saturday</p>
</div>
</div>
</div>
</div>
...
<h2 className="text-2xl md:text-4xl font-bold text-gray-800 mb-3 md:mb-4">Our Clients & Testimonials</h2>
<p className="text-sm md:text-base text-gray-600 max-w-2xl mx-auto px-2">
We're proud to serve some of the most prestigious establishments in Calicut.
</p>
</div>
{/* Clients */}
<div className="mb-16">
<h3 className="text-2xl font-bold text-gray-800 mb-8 text-center">Trusted By</h3>
...
<h4 className="text-lg font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Malabar Palace</h4>
...
<div className="text-center">
<h4 className="text-lg font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Hyson Heritage</h4>
<p className="text-sm text-gray-500 font-light">Calicut</p>
</div>
</div>
<div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer">
...
<div className="text-center">
<h4 className="text-lg font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">City Hospital</h4>
<p className="text-sm text-gray-500 font-light">Calicut</p>
</div>
</div>
<div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer">
...
<div className="text-center">
<h4 className="text-lg font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Grand Restaurant</h4>
<p className="text-sm text-gray-500 font-light">Calicut</p>
</div>
</div>
</div>
...
<div>
<h4 className="text-lg font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Rajesh Kumar</h4>
...
"We've been using K. Kunjiraman's cleaning products for over a decade. Their quality is consistently excellent, and their service is reliable. They understand our hotel's specific needs and always deliver the right solutions."
</p>
</div>
<div className="bg-white p-6 rounded-lg shadow-md group transition-all duration-300 hover:-translate-y-2 hover:shadow-xl cursor-pointer">
<div className="flex items-center mb-4">
...
<div>
<h4 className="text-lg font-bold text-gray-800 transition-colors duration-300 group-hover:text-blue-600">Priya Menon</h4>
...
<p className="text-gray-600 italic transition-colors duration-300 group-hover:text-gray-800">
"The team at K. Kunjiraman Cleaning Solutions provides exceptional service and high-quality products. Their expertise in recommending the right cleaning solutions for different areas of our establishment has been invaluable."
</p>
</div>
</div>
</div>
...
<h2 className="text-2xl md:text-4xl font-bold mb-4 md:mb-6">Ready to Transform Your Cleaning Experience?</h2>
<p className="text-lg md:text-xl mb-6 md:mb-8 max-w-2xl mx-auto px-2">
Contact us today to discuss your cleaning requirements and find the perfect solutions.
</p>
...
{/* Footer */}
<footer id="contact" className="bg-gray-900 text-white pt-8 md:pt-16 pb-8">
<div className="container mx-auto px-4">
<div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8 md:mb-12">
{/* Company Info */}
<div>
<h3 className="text-2xl font-bold text-white mb-6">K. Kunjiraman</h3>
<p className="text-gray-400 mb-4">
Authorised Diversey & Taski dealers in Calicut, offering reliable cleaning solutions for every space and surface.
</p>
...
<li><a href="#home" onClick={(e) => { e.preventDefault(); document.getElementById('home').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Home</a></li>
<li><a href="#about" onClick={(e) => { e.preventDefault(); document.getElementById('about').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">About Us</a></li>
<li><a href="#services" onClick={(e) => { e.preventDefault(); document.getElementById('services').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Services</a></li>
<li><a href="#clients" onClick={(e) => { e.preventDefault(); document.getElementById('clients').scrollIntoView({ behavior: 'smooth' }); }} className="text-gray-400 hover:text-white transition duration-300 cursor-pointer">Clients</a></li>
</ul>
</div>
{/* Contact Details */}
<div>
...
<span className="text-gray-400">K.Kunhiraman Plasto Planet, Court Rd, Mananchira, Kozhikode, Kerala 673032</span>
</li>
...
&copy; {new Date().getFullYear()} K. Kunjiraman Cleaning Solutions. All rights reserved.
</p>
<p className="text-gray-500">
Made by <a href="https://www.marketlube.in" target="_blank" rel="noopener noreferrer" className="underline hover:text-blue-400 transition-colors duration-300">marketlube</a>
</p>
</div>
</div>
</footer>
